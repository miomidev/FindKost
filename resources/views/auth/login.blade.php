            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-gray-300 after:mt-0.5 after:flex-1 after:border-t after:border-gray-300">
                        <p class="mx-4 mb-0 text-center text-sm font-semibold text-gray-500">atau</p>
                    </div>

                    <a href="{{ route('google.login') }}"
                        class="auth-button flex items-center justify-center w-full py-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold text-lg transition gap-2">
