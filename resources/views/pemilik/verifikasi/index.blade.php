                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap flex-md-nowrap justify-content-center gap-1">
                                                ...
                                                <form action="{{ route('pemilik.verifikasi.destroy', $item->id) }}" method="POST" class="flex-fill flex-md-grow-0" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data pembayaran ini?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-secondary w-100 w-md-auto">
