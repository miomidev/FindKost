...
">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('pemilik.kamar.index') }}" class="btn btn-outline-primary px-4 rounded-pill">
...
@media (max-width: 768px) {
    ...
    /* Hilangkan jarak paksa di card kanan */
    .col-md-5 > div[style*="height:38px"] {
        display: none;
    }
    ...
    /* Card fasilitas */
    .col-md-7 .row.g-2 > div {
        margin-bottom: 8px;
    }

    /* Fasilitas jadi 1 kolom penuh di HP */
    .col-md-7 .row.g-2 .col-6 {
        width: 100%;
    }

    /* Tombol kembali full width biar rapi */
