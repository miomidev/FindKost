                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap flex-md-nowrap justify-content-center gap-1">
                                                <a href="{{ route('pemilik.pengajuan.show', $p->id) }}"
                                                    class="btn btn-sm btn-warning text-white flex-fill flex-md-grow-0">
                                                    <i class="bi bi-eye"></i> Detail
                                                </a>
                                                <form action="{{ route('pemilik.pengajuan.destroy', $p->id) }}" method="POST" class="flex-fill flex-md-grow-0" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data pengajuan ini?');">
                                                    @csrf
                                                    @method('DELETE')
