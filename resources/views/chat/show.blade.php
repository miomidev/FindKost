...
@section('content')
        ...
        <div class="flex-grow-1 chat-page-wrapper">
            ...
            <div class="chat-container">
                ...
                <div class="chat-header">
                    ...
                    <form action="{{ route('chat.destroy', $chat->id) }}" method="POST" class="ms-auto delete-chat-form">
                        @csrf
                        @method('DELETE')
                        <button type="button" class="btn btn-sm btn-outline-danger rounded-pill btn-delete-chat" title="Hapus Obrolan">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const btnDeleteChat = document.querySelector('.btn-delete-chat');
            if (btnDeleteChat) {
                btnDeleteChat.addEventListener('click', function(e) {
