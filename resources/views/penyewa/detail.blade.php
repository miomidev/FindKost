                        ...
                        <div class="card shadow-sm border-0 rounded-4">
                            <div class="card-header bg-white border-0 pt-4 px-4">
                                <h5 class="mb-0 fw-semibold">
                                    <i class="bi bi-images me-2"></i>Galeri Foto Kos
                                </h5>
                            </div>
                        ...
                        <div class="card shadow-sm border-0 rounded-4 mb-4 w-100">
                            <div class="card-body p-4">
                                ...
                                <h5 class="fw-semibold mb-4">
                                    <i class="bi bi-house-door-fill me-2"></i>Informasi Detail Kos
                                </h5>
                                <div class="mb-2 fs-6">
                                ...
                                <div class="mb-2 fs-6">
                                    <span class="text-muted">Lokasi Kos:</span> {{ $kos->lokasi }}
                                </div>
                                <div class="mb-2 fs-6">
                                    <span class="text-muted">Tipe Kos:</span> {{ $kos->tipe_kos }}
                                </div>
                        ...
                        <div class="card shadow-sm border-0 rounded-4">
                            <div class="card-body p-4">
                                <h5 class="fw-semibold mb-3">
                                    <i class="bi bi-file-text-fill me-2"></i>Deskripsi Kos
                                </h5>
                ...
                <div class="row g-4 mt-4">
                    ...
                    <div class="col-md-5">
                        <div class="card shadow-sm border-0 rounded-4 mb-4 w-100">
                            <div class="card-body p-4">
                                <h5 class="fw-semibold mb-3">
                                    <i class="bi bi-check2-square me-2"></i>Fasilitas Kos
                                </h5>
                                @php
                                ...
                                <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden d-flex flex-column">
                                    ...
                                    @if (count($fotoKamar) > 0)
                                        <div id="carouselKamar{{ $kamar->id }}" class="carousel slide"
                                            ...
                                            <button class="carousel-control-prev" type="button"
                                                data-bs-target="#carouselKamar{{ $kamar->id }}" data-bs-slide="prev">
                                                <span class="carousel-control-prev-icon"></span>
                                            </button>

                                            {{-- Tombol Next --}}
                                            <button class="carousel-control-next" type="button"
                                                data-bs-target="#carouselKamar{{ $kamar->id }}" data-bs-slide="next">
                                                <span class="carousel-control-next-icon"></span>
                                            </button>
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="text-primary fw-bold">
                                                ...
                                                <span class="text-muted fw-normal">/
                                                    {{ $kamar->tipe_harga === 'tahunan' ? 'tahun' : 'bulan' }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            @if ($adaSewaAktif)
                                                <button type="button" class="btn btn-primary rounded-pill w-100 py-2"
                                                    onclick="Swal.fire({icon: 'warning', title: 'Perhatian!', text: 'Anda masih memiliki sewa yang aktif. Selesaikan atau akhiri masa sewa terlebih dahulu sebelum mengajukan sewa baru.'})">
                                                    Ajukan Sewa
                                                </button>
                                            @elseif ($kamar->status == 'tersedia' && !$sudahAjukan)
