...
Route::middleware('auth')->group(function () {
    ...
    ->name('pemilik.profile.deletePhoto');
        ...
        Route::delete(
            '/pemilik/pengajuan/{id}',
            [App\Http\Controllers\Pemilik\PengajuanController::class, 'destroy']
        )->name('pemilik.pengajuan.destroy');
        Route::get(
            '/pemilik/pembayaran',
        ...
        Route::delete(
            ...
            [App\Http\Controllers\Pemilik\VerifikasiPembayaranController::class, 'destroy']
        )->name('pemilik.verifikasi.destroy');
        Route::post(
